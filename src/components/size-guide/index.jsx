    ...
    <>
      <div className="newsletter fp size-guide" id="size-guide-form">
        ...
        <div className="center-box">
          <div className="newsletter-heading">
            <h3>SIZE GUIDE</h3>
            <button className="btn-blank" onClick={onClose}>
              <img
      ...
      {showFullSizeGuide && (
        <div className="newsletter fp size-guide" id="size-guide-full-form">
          <div className="bg" onClick={onCloseFullGuide}></div>
          <div className="center-box">
            <div className="newsletter-heading">
              ...
              <button className="btn-blank" onClick={onCloseFullGuide}>
                <img
                  src="./src/assets/images/icons/Cross-Button.png"
                  className="close-btn-newsletter"
                  alt=""
                  ...
                  >
                    <div className="accordion-body">
                      <p className="text-black">
                        ...
                        elit. Magni totam, atque nisi alias illum velit itaque,
                        ...
                        enim at, numquam veritatis ducimus cupiditate dolor
                        earum tempore placeat inventore modi atque. Laboriosam
                        id iste modi sed, dolorem optio obcaecati eveniet
                        aliquid incidunt nostrum eum quidem perspiciatis earum
                        animi nisi ducimus aliquam et assumenda dolorum sapiente
                        voluptas, cumque, excepturi ex laborum aut! Adipisci
                        optio laudantium ex quibusdam totam quam cumque, soluta
                        magni id doloremque libero unde debitis distinctio sint
                        repudiandae sed. Amet dicta quas delectus ratione enim
                        deleniti officiis, tempore impedit tempora nisi nesciunt
                        perspiciatis ipsum fugiat commodi expedita dolores!
                      </p>
                    </div>
                  </div>
                </div>
